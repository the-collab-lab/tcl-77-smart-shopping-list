...
/**
 * This uses the ListItem type to set the type for the newData in the updateItem function
 * The Omit is used to make sure that when passing newData the id (generated by firebase for the doc)
 * can't be updated and the dateCreated can't be updated.
 *
 * The Partial allows the remaining types to be optional so when passing newData only the info that
 * needs to be updated has to be passed not the whole object.
 */
export type UpdateListItem = Partial<Omit<ListItem, "id" | "dateCreated">>;
